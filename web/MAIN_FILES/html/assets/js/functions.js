...
(function ($) {
    ...
    contactForm.validate({
        ...
        submitHandler: function (contactForm) {
            ...
            $(contactResult, contactForm).html('<div class="alert alert-success" style="margin-top:30px" role="alert"><strong>Thank you. We will email you shortly.</strong></div>').delay(3000).fadeOut(2000);
